...
If you usually use for loops then the foreach package might be easier to use. This can be used with future to create the backend using the doFuture package. See script "analyses/02_run_model_foreach.R" for an example.
